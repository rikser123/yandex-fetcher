...
public class SearchResponse {
  ...
  @JoinColumn(name = "user_search_query_id")
  @ManyToOne
  private UserSearchQuery userSearchQuery;

  @OneToMany(mappedBy = "searchResponse", fetch = FetchType.LAZY, cascade = { CascadeType.MERGE, CascadeType.PERSIST })
  private Set<SearchResponseError> errors;
